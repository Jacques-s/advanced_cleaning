...
class VerificationPDF {
  ...
  pw.Widget itemRow(String questionTitle, String frequency, String dueDate,
          String result) =>
      pw.Row(
        children: [
          cellItem(questionTitle, 3),
          ...
          pw.Expanded(
            ...
            child: pw.Container(
              ...
              decoration: pw.BoxDecoration(
                border:
                    pw.Border.all(color: PdfColor.fromHex('#000'), width: 0.5),
              ),
              child: pw.Center(
                child: result == 'pass'
                    ? pw.Icon(
                        const pw.IconData(0xe5ca),
                        size: pdfFontSizeGeneral + 1,
                    ...
                    : result == 'fail'
                        ? pw.Icon(
                            ...
                            size: pdfFontSizeGeneral + 1,
                            color: PdfColor.fromHex('#ab240c'),
                          )
                        : pw.Text(
                            '-',
                            style: const pw.TextStyle(
                                fontSize: pdfFontSizeGeneral + 1),
                          ),
              ),
            ),
          ),
  ...
  Future<void> generateReport() async {
    ...
    String filePath = await helper.savePDFFile(pdf, 'Verification.pdf');
